...
def ingame_menu(screen, screen_width, screen_height):
    ...
    screen.blit(counter_1, (265, 370))
    pygame.draw.rect(screen, RED, (375, 350, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (386, 350))
    screen.blit(counter_1, (435, 370))
    # Section 2.
    pygame.draw.rect(screen, RED, (35, 430, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (41, 430))
    screen.blit(counter_1, (95, 450))
    pygame.draw.rect(screen, GREEN, (205, 430, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name2, (241, 430))
    screen.blit(counter_2, (265, 450))
    pygame.draw.rect(screen, GREEN, (375, 430, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name2, (417, 430))
    screen.blit(counter_2, (435, 450))
    # Section 3.
    pygame.draw.rect(screen, RED, (35, 510, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (41, 510))
    screen.blit(counter_1, (95, 530))
    pygame.draw.rect(screen, GREEN, (205, 510, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name2, (241, 510))
    screen.blit(counter_2, (265, 530))
    pygame.draw.rect(screen, RED, (375, 510, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (386, 510))
    screen.blit(counter_1, (435, 530))
    ...
    pygame.draw.rect(screen, RED, (295, 605, 160, 80), DTHRU_OUTLINE)
    screen.blit(patty_name2, (330, 605))
    screen.blit(counter_1, (355, 640))
    pygame.draw.rect(screen, RED, (475, 605, 80, 80), DTHRU_OUTLINE)
    screen.blit(patty_name, (495, 605))
    screen.blit(counter_1, (495, 640))
