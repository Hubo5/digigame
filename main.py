...
def ingame_menu(screen, screen_width, screen_height):
    ...
    pygame.draw.rect(screen, RED, (35, 350, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (41, 350))
    screen.blit(counter_1, (95, 370))
    ...
    pygame.draw.rect(screen, RED, (205, 430, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (211, 430))
    screen.blit(counter_1, (265, 450))
    pygame.draw.rect(screen, RED, (375, 430, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (386, 430))
    screen.blit(counter_1, (435, 450))
    # Section 3.
    pygame.draw.rect(screen, RED, (35, 510, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (41, 510))
    screen.blit(counter_1, (95, 530))
    pygame.draw.rect(screen, RED, (205, 510, 160, 60), DTHRU_OUTLINE)
    screen.blit(burger_name, (211, 510))
    screen.blit(counter_1, (265, 530))
